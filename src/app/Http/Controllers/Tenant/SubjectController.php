...
class SubjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            'code'            => 'required|string|max:20|unique:tenant.subjects,code',
        ...
        return redirect()->route('tenant.subjects.index')
    ...
    {
        $validated = $request->validate([
            'code'            => 'required|string|max:20|unique:tenant.subjects,code,' . $subject->id,
            'name'            => 'required|string|max:255',
            'education_level' => 'required|in:SD,SMP,SMA',
            'grade_level'     => 'nullable|integer|min:1|max:12',
            'kkm'             => 'required|numeric|min:0|max:100',

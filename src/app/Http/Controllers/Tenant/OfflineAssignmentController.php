...
use App\Models\Tenant\OfflineAssignmentAnswer;
use App\Models\Tenant\OfflineAssignmentQuestion;
...
class OfflineAssignmentController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ($request->meeting_id) {
            $meeting = \App\Models\Tenant\Meeting::with('teachingAssignment.subject', 'teachingAssignment.schoolClass')
    ...
    public function store(Request $request)
    {
        ...
        if ($request->meeting_id) {
            $meeting = \App\Models\Tenant\Meeting::find($request->meeting_id);
            if ($meeting) {
                return redirect("/tenant/courses/{$meeting->teaching_assignment_id}")->with('success', 'Tugas berhasil dibuat.');
            }
        }

        return to_route('tenant.assignments.index')->with('success', 'Tugas berhasil dibuat.');
    }
    ...
    public function update(Request $request, OfflineAssignment $offlineAssignment)
    {
        ...
        return to_route('tenant.assignments.index')->with('success', 'Tugas berhasil diperbarui.');
    }
    ...
    public function storeCorrection(Request $request, OfflineAssignment $offlineAssignment, Student $student)
    {
        ...
        return to_route('tenant.offline-assignments.show', $offlineAssignment->id)

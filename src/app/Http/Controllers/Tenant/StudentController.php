...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'nis'          => 'required|string|max:20|unique:tenant.students',
            'nisn'         => 'nullable|string|max:20|unique:tenant.students',
    ...
    public function update(Request $request, Student $student)
    {
        ...
        $validated = $request->validate([
            'nis'          => "required|string|max:20|unique:tenant.students,nis,{$student->id}",
            'nisn'         => "nullable|string|max:20|unique:tenant.students,nisn,{$student->id}",
            'name'         => 'required|string|max:255',
            'gender'       => 'nullable|in:male,female',
            'birth_place'  => 'nullable|string|max:100',
            'birth_date'   => 'nullable|date',

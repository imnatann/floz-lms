...
class TeacherController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'nip'         => 'nullable|string|max:30|unique:tenant.teachers,nip',
            'nuptk'       => 'nullable|string|max:30|unique:tenant.teachers,nuptk',
            'email'       => 'nullable|email|max:255|unique:tenant.teachers,email',
    ...
    public function update(Request $request, Teacher $staff)
    {
        ...
        $validated = $request->validate([
            'name'        => 'required|string|max:255',
            'nip'         => 'nullable|string|max:30|unique:tenant.teachers,nip,' . $staff->id,
            'nuptk'       => 'nullable|string|max:30|unique:tenant.teachers,nuptk,' . $staff->id,
            'email'       => 'nullable|email|max:255|unique:tenant.teachers,email,' . $staff->id,
            'phone'       => 'nullable|string|max:20',
            'gender'      => 'required|in:male,female',
            'birth_place' => 'nullable|string|max:100',
            'birth_date'  => 'nullable|date',

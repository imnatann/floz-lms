...
const submit = () => {
    form.post('/tenant/offline-assignments');
};
</script>
...
<template>
  ...
  <div class="max-w-4xl mx-auto space-y-6 pb-24">
    ...
    <div class="flex items-center gap-4">
        <Link href="/tenant/offline-assignments" class="p-2 hover:bg-slate-100 rounded-lg transition-colors text-slate-500">
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 shadow-lg z-10 md:pl-64">
        <div class="max-w-4xl mx-auto flex justify-end gap-3">
             <Link href="/tenant/offline-assignments">

    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
      <div>
        ...
        <nav class="flex text-sm text-slate-500 mt-1">
          ...
          <Link href="/tenant/assignments" class="hover:text-blue-600">Tugas</Link>
          <span class="mx-2">/</span>
                ...
                <tbody class="divide-y divide-slate-200">
                    <tr v-for="student in students.data" :key="student.id" class="hover:bg-slate-50">
                        ...
                        <td class="px-6 py-3 text-right">
                             <Link :href="`/tenant/assignments/${assignment.id}/student/${student.id}`" class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors">

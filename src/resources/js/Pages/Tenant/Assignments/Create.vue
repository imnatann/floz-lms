...
<template>
  ...
  <div class="max-w-4xl mx-auto space-y-6 pb-24">
    ...
    <div class="flex items-center gap-4">
        <Link href="/tenant/assignments" class="p-2 hover:bg-slate-100 rounded-lg transition-colors text-slate-500">

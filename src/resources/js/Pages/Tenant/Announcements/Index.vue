...
watch(search, debounce((value) => {
  router.get('/tenant/announcements', { search: value }, { preserveState: true, replace: true });
}, 300));
  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <Button href="/tenant/announcements/create" class="flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      <Link 
        ...
        :key="announcement.id"
        :href="`/tenant/announcements/${announcement.id}`"

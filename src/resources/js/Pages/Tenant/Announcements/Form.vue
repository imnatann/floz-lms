  ...
  <div class="mx-auto max-w-3xl pb-20 pt-8 px-4 sm:px-0">
    ...
    <div class="flex items-center justify-between mb-8">
       <div class="text-sm text-slate-500 breadcrumbs">
          <ul>
            <li><Link href="/tenant/dashboard" class="hover:text-slate-800">Dashboard</Link></li>
            <li><Link href="/tenant/announcements" class="hover:text-slate-800">Pengumuman</Link></li>
            <li><span class="text-slate-800 font-medium">{{ announcement ? 'Edit' : 'Baru' }}</span></li>
          </ul>
       </div>
       <div class="flex items-center gap-2">
          <Link href="/tenant/announcements" class="px-3 py-1.5 text-sm text-slate-500 hover:text-slate-800 transition-colors">
            Discard
          </Link>

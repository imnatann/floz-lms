...
<template>
  ...
  <div>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <Button href="/tenant/subjects/create">
          ...
          <tr v-for="s in subjects.data" :key="s.id" class="transition-colors hover:bg-slate-50/50">
            ...
            <td class="px-5 py-3.5 text-right">
              <div class="flex items-center justify-end gap-1">
                <Link :href="`/tenant/subjects/${s.id}/edit`" class="rounded-lg p-1.5 text-slate-400 hover:bg-orange-50 hover:text-orange-600" title="Edit">

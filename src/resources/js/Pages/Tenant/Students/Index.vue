  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex gap-2">
        ...
        <Button v-if="permissions.manage_students" href="/tenant/students/create" size="sm">
            ...
            >
              ...
              <td class="px-4 py-3 text-right">
                <div class="flex items-center justify-end gap-1">
                  <Button :href="`/tenant/students/${student.id}`" variant="ghost" size="xs">Detail</Button>
                  <Button v-if="permissions.manage_students" :href="`/tenant/students/${student.id}/edit`" variant="ghost" size="xs">Edit</Button>
                </div>
              </td>
            </tr>
            <tr v-if="!students.data?.length">
              <td colspan="6" class="px-4 py-12 text-center">
                <div class="flex flex-col items-center gap-2">
                  ...
                  <Button v-if="permissions.manage_students" href="/tenant/students/create" size="sm" class="mt-2">Tambah Siswa</Button>
                </div>
              </td>
            </tr>
          </tbody>

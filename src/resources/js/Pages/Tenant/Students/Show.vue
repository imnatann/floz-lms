  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div class="flex items-center gap-4">
        <Button href="/tenant/students" variant="outline" size="sm">
      ...
      <div class="flex gap-2">
        <Button v-if="permissions.manage_students" :href="`/tenant/students/${student.id}/edit`" variant="outline" size="sm">

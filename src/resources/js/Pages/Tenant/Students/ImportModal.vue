...
const submit = () => {
    form.post('/tenant/students/import', {
        onSuccess: () => {
            form.reset();
            emit('close'); 
        },
    ...
    <Modal :show="show" @close="close" maxWidth="md">
        <div class="p-6">
            ...
            <div class="mt-6 space-y-4">
                <a href="/tenant/students/template" class="flex items-center gap-2 text-sm font-medium text-emerald-600 hover:text-emerald-700">

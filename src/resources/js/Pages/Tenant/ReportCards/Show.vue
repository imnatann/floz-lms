  ...
  <div class="mx-auto max-w-4xl space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div class="flex items-center gap-4">
        <Button href="/tenant/report-cards" variant="outline" size="sm">
      ...
      <div class="flex gap-2">
        <Button :href="`/tenant/report-cards/${reportCard.id}/pdf`" tag="a" variant="outline" size="sm">
          <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
          Download PDF
        </Button>
        <Link
          v-if="reportCard.status === 'draft'"
          :href="`/tenant/report-cards/${reportCard.id}/publish`"
          method="post"
          as="button"

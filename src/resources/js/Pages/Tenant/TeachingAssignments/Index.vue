...
<template>
  ...
  <div>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <Button href="/tenant/teaching-assignments/create">
        ...
        <tbody class="divide-y divide-slate-100">
          <tr v-for="item in assignments.data" :key="item.id" class="transition-colors hover:bg-slate-50/50">
            ...
            <td class="px-5 py-3.5 text-right flex justify-end gap-2">
              <Link :href="`/tenant/teaching-assignments/${item.id}/edit`" class="rounded-lg p-1.5 text-slate-400 hover:bg-amber-50 hover:text-amber-500" title="Edit">

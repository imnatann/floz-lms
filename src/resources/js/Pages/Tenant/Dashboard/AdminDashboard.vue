      ...
      <div class="space-y-6 lg:col-span-2">
        ...
        <Card title="Absensi Hari Ini" subtitle="Rekap kehadiran siswa hari ini">
          ...
          <div class="mt-4 flex justify-end">
            <Button href="/tenant/attendance" variant="outline" size="sm">
              Kelola Absensi →
            </Button>
          </div>
        </Card>
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
          <Link href="/tenant/students/create" class="group flex flex-col items-center justify-center rounded-xl border border-slate-200 bg-white p-4 transition-all hover:border-blue-500 hover:shadow-md">
           ...
           <Link href="/tenant/announcements/create" class="group flex flex-col items-center justify-center rounded-xl border border-slate-200 bg-white p-4 transition-all hover:border-amber-500 hover:shadow-md">
          ...
          <Link href="/tenant/staff" class="group flex flex-col items-center justify-center rounded-xl border border-slate-200 bg-white p-4 transition-all hover:border-indigo-500 hover:shadow-md">
          ...
          <Link href="/tenant/report-cards" class="group flex flex-col items-center justify-center rounded-xl border border-slate-200 bg-white p-4 transition-all hover:border-purple-500 hover:shadow-md">
        ...
        <Card title="Pengumuman Terbaru" class="h-full">
          <div class="space-y-4">
            <div 
              ...
              :key="announcement.id"
              class="relative border-l-2 border-blue-500 pl-4 transition-all hover:translate-x-1"
            >

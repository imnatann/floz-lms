...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void _changeSchool() {
    ref
        .read(authProvider.notifier)
        .selectTenant({}); // Clear tenant (hacky, should have explicit clear)
    // Actually simpler to just go to search, but clearing helps router decide
    // Better method:
    // ref.read(authProvider.notifier).clearTenant();
    // But I haven't implemented clearTenant, so let's just go back
